...
const CartModal = ({ products, isOpen, onClose }) => {
  ...
  ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
    ...
    >
      <div
        className={`fixed right-0 top-0 md:w-1/3 w-full bg-white h-full
      overflow-auto transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
        style={{ transition: 'transfrom 300ms cubic-bezier(0.25, 0.46, 0.45, 0.94)' }}
      >
